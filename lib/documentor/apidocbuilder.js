...
function ApidocManager(){
	...
	this.init = function(globalConfig, groupConfig, pathOfProject)
	{	global = globalConfig;
		group = groupConfig;
		pathOP = pathOfProject;
	};
	...
	{	
		if(typeof group[I_SOURCE_DIR] != "undefined"){
			return this.normalizePath(group[I_SOURCE_DIR]);
		}
		return this.normalizePath(global[I_SOURCE_DIR]);	
	};
